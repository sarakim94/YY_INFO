        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white">Page not found. Don't worry though, we can go to login page.</p>
              <div @click="logout">
              <nuxt-link to="/" class="font-weight-bold text-white mt-5" >Back to login</nuxt-link>
              </div>
            </div>
          </div>
        </div>
